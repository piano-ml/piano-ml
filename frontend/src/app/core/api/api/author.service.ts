...
// @ts-ignore
import { AuthorApiInfo } from '../model/authorApiInfo';
...
export class AuthorService extends BaseService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public authorPost(authorApiInfo: AuthorApiInfo, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<AuthorApiInfo>;
    public authorPost(authorApiInfo: AuthorApiInfo, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<AuthorApiInfo>>;
    public authorPost(authorApiInfo: AuthorApiInfo, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<AuthorApiInfo>>;
    public authorPost(authorApiInfo: AuthorApiInfo, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (authorApiInfo === null || authorApiInfo === undefined) {
            throw new Error('Required parameter authorApiInfo was null or undefined when calling authorPost.');
        }
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<AuthorApiInfo>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: authorApiInfo,
                responseType: <any>responseType_,
    ...
    /**
     * Search authors
     * @param query The ID of the author
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public authorSearchQueryGet(query: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<AuthorApiInfo>>;
    public authorSearchQueryGet(query: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<AuthorApiInfo>>>;
    public authorSearchQueryGet(query: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<AuthorApiInfo>>>;
    public authorSearchQueryGet(query: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (query === null || query === undefined) {
            throw new Error('Required parameter query was null or undefined when calling authorSearchQueryGet.');
        }
        ...
        let localVarPath = `/author/search/${this.configuration.encodeParam({name: "query", value: query, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<AuthorApiInfo>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
