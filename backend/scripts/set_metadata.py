...
def process_musicxml(path, title, composer):
    """Lit un fichier MusicXML, supprime les notes cue, parse le XML nettoyé avec music21,
    ...
    print(f"Wrote updated MusicXML to {path} (removed {removed_count} cue note(s), {ornaments_removed} ornament(s)).")
