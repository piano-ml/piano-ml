...
./scripts/midi2pack.sh  "$CUR_DIR"/samples/test.mid "test title" "test composer" 1 0 1 || exit 1

cp "$CUR_DIR"/samples/src_test1.midi "$CUR_DIR"/samples/test.mid
./scripts/midi2pack1.sh  "$CUR_DIR"/samples/test.mid "test title" "test composer" 1 0 1 || exit 1
